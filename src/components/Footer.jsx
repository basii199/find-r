...
const Footer = () => {
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: 'Featured', to: '/products?filter=featured' },
        { name: 'New Arrivals', to: '/products?filter=new' },
        { name: 'Deals', to: '/products?filter=deals' }
      ]
    },
    {
      title: 'Help',
  ...
  return (
    <footer className="bottom-0 bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Find-r. All rights reserved.
          </p>
